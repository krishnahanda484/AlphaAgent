...
- An [OpenAI API key](https://aistudio.google.com/app/apikey) (for the Gemini research agent)
...
| API returning 500 | Check that `DATABASE_URL` and `GOOGLE_API_KEY` are set |
