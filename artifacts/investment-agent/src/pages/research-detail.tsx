          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            {overallScore != null && scoreEntries.length > 0 && (
              <div className="bg-card border border-border rounded-xl p-4 sm:p-5">
                ...
                <p className="text-xs text-muted-foreground mt-4">
                  Scores are generated by Gemini based on real market data. Higher = stronger. Risk score: 100 = very low risk.
                </p>
              </div>
            )}
            ...
            <div className="bg-card border border-border rounded-xl p-4 sm:p-5">
              ...
              <div className="flex flex-wrap items-center gap-2">
                {[
                  ...
                  { icon: "🧠", label: "Gemini", sub: "LLM reasoning" },
            ...
            {s.completedAt && (
              <p className="text-xs text-muted-foreground text-center pt-2">
                Analysis completed {new Date(s.completedAt).toLocaleString()} · AlphaAgent powered by LangGraph + Gemini + Yahoo Finance
              </p>
            )}
          </div>
        )}
